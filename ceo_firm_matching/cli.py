"""
CEO-Firm Matching: Command Line Interface

Entry point for training and analysis.
"""
import argparse
...
from .explain import ModelWrapper, explain_model_pdp
from .visualization import plot_interaction_heatmap


def main():
    """Main entry point for the CEO-Firm matching pipeline."""
